...
return {
    ...
    -- =========================================================================
    {
        ...
        init = function()
            ...
            vim.g.db_ui_save_location =
                vim.fn.stdpath("data") .. "/db_ui_queries"
        ...
        config = function()
            ...
            local function apply_db_buffer_keymaps(buf)
                ...
                map(
                    ...
                    "<leader>de",
                    ":DB<CR>",
                    opts("[D]atabase [E]xecute selection")
                )
                ...
                map(
                    ...
                    opts("[D]atabase e[D]it bind parameters")
                )
            end
    ...
    -- =========================================================================
    {
        ...
        config = function()
            -- ================================================================
            -- SQL-specific nvim-cmp configuration
            -- ================================================================
            --
            -- dadbod completion is added ONLY to SQL-related buffers.
            --
            -- This prevents the dadbod source from interfering with normal
            -- completion in Java, Lua, Python, etc.
            --
            vim.api.nvim_create_autocmd("FileType", {
                pattern = {
                    "sql",
